  ...
  return (
    <div className="flex flex-col items-center text-center mb-10 animate-fade-in-up">
      <div className="relative group mb-6">
        ...
        <div className="relative w-32 h-32 rounded-full overflow-hidden border-[1px] border-white/10 bg-white p-1 shadow-2xl shadow-primary/20">
          <img 
      ...
      <h1 style={{ fontFamily: "'Kalam', cursive" }} className="text-4xl font-heading font-bold tracking-tight mb-2 text-transparent bg-clip-text bg-gradient-to-r from-white via-white to-gray-400 drop-shadow-sm">
        {profile.name}
      </h1>
